...
const themes = {
  dark: {
    ...
    navLink:        "text-[#C8C4B4] hover:text-[#E8E4D8] after:bg-[#7FA87F]",
    dropdownBg:     "bg-[#1E3A1E] border-[#2D5A2D]",
    dropdownItem:   "border-[#2D5A2D]",
    dropdownBtn:    "text-[#C8C4B4] hover:text-[#E8E4D8] hover:bg-[#2D5A2D]",
    langBtn:        "text-[#C8C4B4] hover:text-[#E8E4D8]",
    langDropdown:   "bg-[#1E3A1E] border-[#2D5A2D]",
    langActive:     "text-[#5A8A5A] cursor-default",
    langOption:     "text-[#E8E4D8] hover:bg-[#2D5A2D]",
    mobileBg:       "bg-[#1E3A1E] border-[#2D5A2D]",
    mobileLink:     "text-[#C8C4B4] hover:text-[#E8E4D8] border-[#2D5A2D]",
    mobileChild:    "text-[#C8C4B4] hover:text-[#E8E4D8]",
